		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nmspTrainHisdwrtraininghistory-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nmspTrainHisdwrtraininghistory-display": {
								"semanticObject": "nmspTrainHisdwrtraininghistory",
								"action": "display",
								"description": "Training History app",
								"title": "Training history",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nmspTrainHis.dwrtraininghistory",
									"url": sap.ui.require.toUrl("nmspTrainHis/dwrtraininghistory")
								}
							}
						}
					}
